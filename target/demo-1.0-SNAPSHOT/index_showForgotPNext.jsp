            ...
            <div class="auth-form forgot-form">
                ...
                <form class="auth-form__form">
                    <div class="success-container">
                        <p>Chúng tôi đã gửi một liên kết khôi phục đến email của bạn.
                            Vui lòng kiểm tra hộp thư (và cả thư rác).</p>
                        
                        <button class = "btn--primary">Quay lại đăng nhập<a href="index_showLogin.jsp" class="nav-link"></a></button>
