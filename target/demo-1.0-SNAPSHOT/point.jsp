    ...
    <div class="header-container">
        <div class="header-top">
            ...
            <nav>
                ...
                <a href="point.html">Điểm thưởng</a>
...
<main class="loyalty-wrapper">
    <h1><i class="fa-solid fa-star"></i> Tích Điểm Khách Hàng</h1>

    <!-- Thông tin khách hàng -->
    <section class="customer-info card">
        <p><strong>👤 Khách hàng:</strong> Nguyễn Văn Tường</p>
        <p><strong>📞 Số điện thoại:</strong> 0903 732 293</p>
        <p><strong>⭐ Tổng điểm hiện có:</strong>
            <span class="points">1,250 điểm</span>
        </p>
    </section>

    <!-- Lịch sử tích điểm -->
    <section class="point-history card">
        ...
        <table class="modern-table">
            ...
            <tr>
                ...
                <th>Hoạt động</th>
                <th>Điểm</th>
                <th>Tổng sau giao dịch</th>
            </tr>
            </thead>
            <tbody>
            <tr>
                <td>10/11/2025</td>
                <td>Mua hàng: Cua Hoàng Đế</td>
                <td class="plus">+250</td>
                <td>1,250</td>
            </tr>
            <tr>
                <td>01/11/2025</td>
                <td>Đổi quà: Voucher 50k</td>
    ...
    <!-- Quà tặng có thể đổi -->
    <section class="redeem-suggestions card">
        <h2>🎁 Voucher có thể đổi</h2>
        <div class="voucher-list">
            <div class="voucher-card">
                <div class="voucher-header">Voucher 50.000₫</div>
                <div class="voucher-body">
                    <p>Hạn sử dụng: 31/12/2025</p>
                </div>
                <button class="redeem-btn">Nhận Voucher</button>
            </div>

            <div class="voucher-card">
                <div class="voucher-header">Miễn phí vận chuyển</div>
                <div class="voucher-body">
    ...
    <!-- Voucher đã lưu -->
    <section class="saved-vouchers card">
        <h2>📦 Voucher đã lưu</h2>
        <ul class="voucher-saved-list">
            <li>Voucher 50.000₫ – HSD: 31/12/2025</li>
            <li>Giảm 10% Cua Gạch – HSD: 15/12/2025</li>
        </ul>
    </section>
</main>
