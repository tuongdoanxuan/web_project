...
<head>
    ...
    <link rel="stylesheet" href="css/logoutInInfoPage.css">
...
<header>
            ...
            <nav>
                ...
                <div class="user-menu">
                    ...
                    <ul class="user-dropdown">
                        ...
                        <li><a href="account.html"><i class="fa-solid fa-id-card"></i> Thông tin tài khoản</a></li>
    ...
    <main>
        ...
        <aside class="sidebar">
            <h3>Tài khoản</h3>
            <ul class="menu">
                <li><a href="account.html" class="active"><i class="fa-solid fa-user"></i> Thông tin tài khoản</a></li>
                <li><a href="change-password.jsp"><i class="fa-solid fa-lock"></i> Đổi mật khẩu</a></li>
                <li><a href="myOrders.jsp"><i class="fa-solid fa-box"></i> Đơn hàng của tôi</a></li>
                <li><a href="favoriteProduct.jsp"><i class="fa-solid fa-heart"></i> Sản phẩm yêu thích</a></li>
                <li><a href="index_noLogin.jsp"><i class="fa-solid fa-right-from-bracket"></i> Đăng xuất</a></li>
            </ul>
        </aside>
        ...
        <section class="account-content">
            ...
            <form class="account-form">
                <div class="form-group">
                    ...
                    <input type="email" id="email" value="doanxuantuong1@gmail.com" />
                </div>

                <div class="form-group">
                    <label for="lastname">Họ và tên đệm:</label>
                    <input type="text" id="lastname" value="Đoàn Xuân" />
                </div>

                <div class="form-group">
                    <label for="firstname">Tên:</label>
                    <input type="text" id="firstname" value="Tường" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="address" value="128 Đào Duy Anh, P.9, Q.Phú Nhuận, TP.HCM" />
                </div>

                <div class="form-group">
                    <button type="submit" class="btn-update" onclick="alertFunction('Cập nhật thành công')">Cập nhật</button>
                </div>
            </form>
    ...
    <!-- Modal xác nhận đăng xuất -->
        <!-- <div class="modal-box">
            ...
            <div class="modal-actions">
                <button onclick="closeLogoutModal()" class="btn-cancel">Hủy</button>
                <a href="#" class="btn-confirm">Đăng xuất</a>
            </div>
        </div> -->
