...
<header>
    ...
    <div class="account-wrapper">
        ...
        <aside class="sidebar">
            <h3>Tài khoản</h3>
            <ul class="menu">
                <li><a href="account.jsp" class="active"><i class="fa-solid fa-user"></i> Thông tin tài khoản</a></li>
                ...
                <li><a href="favoriteProduct.html"><i class="fa-solid fa-heart"></i> Sản phẩm yêu thích</a></li>
                <li><a href="index_noLogin.jsp"><i class="fa-solid fa-right-from-bracket"></i> Đăng xuất</a></li>
            </ul>
        </aside>
        ...
        <section class="account-content">
            ...
            <div class="favorites-list">
                <div class="favorite-row">
                    ...
                    <a href="products_detail.jsp" class="btn-view">Xem sản phẩm</a>
                    <button class="btn-remove" onclick="alertFunction('Xóa sản phẩm thành công')"><i class="fa-solid fa-trash"></i></button>
                </div>
