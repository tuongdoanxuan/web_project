...
<main class="payment-wrapper">
    ...
    <section class="payment-section">
        ...
        <form class="payment-form">
            <label>Họ tên</label>
            <input type="text" placeholder="Nguyễn Văn Tường" required />

            <label>Số điện thoại</label>
            <input type="tel" placeholder="0903 732 293" required />

            <label>Địa chỉ giao hàng</label>
            <textarea placeholder="128 Đào Duy Anh, P.9, Q.Phú Nhuận, TP.HCM" required></textarea>
        </form>
    </section>
    ...
    <section class="payment-section">
        ...
        <div class="payment-methods">
            <label><input type="radio" name="method" checked /> Thanh toán khi nhận hàng (COD)</label>
            <label><input type="radio" name="method" /> Chuyển khoản ngân hàng</label>
            <label><input type="radio" name="method" /> Ví điện tử (Momo, ZaloPay...)</label>
        </div>
    </section>

    <!-- 3. Đổi điểm tích lũy -->
    <section class="payment-section">
        <h2>3. Đổi điểm tích lũy</h2>
        <form class="points-form">
            <label>Số điểm hiện có: <strong id="availablePoints">120</strong></label>
            <label>Nhập số điểm muốn đổi</label>
            <input type="number" id="pointsInput" min="0" max="120" placeholder="Nhập số điểm..." />
            <p class="note">* 1 điểm = 1.000₫</p>
        </form>
    </section>

    <section class="payment-section">
        <h2>4. Chọn Voucher</h2>
        <form class="voucher-form">
            <label>Chọn voucher áp dụng</label>
            <select id="voucherSelect">
                <option value="">-- Chọn voucher --</option>
                <option value="GIAM50K">Giảm 50.000₫</option>
                <option value="FREESHIP">Freeship (giảm 30.000₫)</option>
                <option value="GIAM10">Giảm 10% tổng đơn</option>
            </select>
        </form>
    </section>
    ...
    <!-- 4. Tóm tắt đơn hàng -->
    <section class="payment-section">
        <h2>5. Tóm tắt đơn hàng</h2>
        <ul class="order-summary">
            <li>
                <span>Tôm Sú Tươi 500g x1</span>
                <span>145.000₫</span>
            </li>
            <li>
                <span>Cua Gạch Cà Mau x1</span>
                <span>220.000₫</span>
            </li>
            ...
            <li id="discountRow">
                ...
                <span id="discountAmount">-20.000₫</span>
            </li>

            <!-- Voucher đã áp dụng -->
            <li id="voucherRow1">
                <span>Voucher GIAM50K</span>
                <span id="voucherAmount1">-50.000₫</span>
            </li>
            <li id="voucherRow2">
                <span>Voucher FREESHIP</span>
                <span id="voucherAmount2">-30.000₫</span>
            </li>

            <li class="total">
                <strong>Tổng cộng:</strong>
                <strong id="totalAmount">265.000₫</strong>
            </li>
        </ul>
    </section>
    ...
    <div class="confirm-area">
        <a class="btn-confirm" href="myOrders_detail.jsp"><i class="fa-solid fa-check"></i> Xác nhận thanh toán</a>
    </div>
</main>
