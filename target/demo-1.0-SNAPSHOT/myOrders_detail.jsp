...
<head>
    ...
    <link rel="stylesheet" href="css/myOrders_detail.css">
...
<section class="order-detail">
    <div class="order-detail-header">
        <a href="#" class="back-btn"><i class="fa-solid fa-arrow-left"></i> Quay lại</a>
        <h2>Chi tiết đơn hàng <span>#DH001</span></h2>
    </div>

    <!-- Thanh theo dõi đơn hàng -->
    <div class="order-tracking">
        <ul class="progressbar">
            <li class="step completed">Đã đặt hàng</li>
            <li class="step completed">Đang xử lý</li>
            <li class="step">Đang giao</li>
            <li class="step">Đã giao</li>
        </ul>
    </div>
    ...
    <div class="order-summary">
        <div class="order-info">
            ...
            <p><strong>Họ tên:</strong> Nguyễn Văn Tường</p>
            <p><strong>SĐT:</strong> 0903 732 293</p>
            <p><strong>Địa chỉ:</strong> 128 Đào Duy Anh, P.9, Q.Phú Nhuận, TP.HCM</p>
        </div>

        <div class="order-info">
            <h4>Thông tin đơn hàng</h4>
            <p><strong>Ngày đặt:</strong> 05/11/2025</p>
            <p><strong>Trạng thái:</strong> <span class="status delivered">Đã giao</span></p>
            <p><strong>Tổng tiền:</strong> <span class="total">365.000₫</span></p>
        </div>
    </div>
    ...
    <div class="order-products">
        ...
        <ul>
            <li>
                <span class="product-name">Tôm Sú Tươi 500g</span>
                <span class="product-qty">x1</span>
                <span class="product-price">145.000₫</span>
            </li>
            <li>
                <span class="product-name">Cua Gạch Cà Mau</span>
                <span class="product-qty">x1</span>
    ...
    <div class="order-actions">
        <button class="cancel-btn"><i class="fa-solid fa-ban"></i> Hủy đơn hàng</button>
    </div>
</section>
