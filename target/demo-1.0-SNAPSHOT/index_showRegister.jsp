        ...
        <div class="header-top">
            ...
            <nav>
                ...
                <div class="user-menu">
                    ...
                    <a href="index_showRegister.html">Đăng ký</a>
                </div>
        ...
        <section class="promo-gallery">
            ...
            <div class="gallery-wrapper">
                ...
                <div class="side-images">
                    <div class="side-item">
                        <img src="assets/img/promo_2.jpg"
                            alt="Cua Lông HongKong Sống" />
                    </div>
                    <div class="side-item">
        ...
        <section class="featured">
            ...
            <div class="product-list">
                <div class="product-card">
                    <img src="https://product.hstatic.net/200000325181/product/1_fee63a7c3f4c4a49b6d22d3397a5eb45_master.jpg"
                        alt="Cua Lông HongKong Sống" />
                    <h3>Cua Lông HongKong Sống</h3>
        ...
        <section class="promotion">
            ...
            <div class="product-list">
                <div class="product-card">
                    <img src="https://product.hstatic.net/200000325181/product/1_fee63a7c3f4c4a49b6d22d3397a5eb45_master.jpg"
                        alt="Cua Lông HongKong Sống" />
                    <h3>Set Mukbang Cá Hồi Mayo Chili</h3>
                    <p class="price">229.000₫</p>
                    <p class="weight">Combo đặc biệt</p>
                    <p class="popularity">Đã bán: 1.263 lượt</p>
                    <span class="tag">ĐANG HOT</span>
                    <div class="rating">
                        <i class="fa-solid fa-star"></i>
                        <i class="fa-solid fa-star"></i>
            ...
            <div class="auth-form register-form">
                <div class="auth-form__container">
                    <div class="auth-form__header">
                        ...
                        <span class="auth-form__switch-btn">Đăng nhập<a class="nav-link" href="index_showLogin.jsp"></a></span>
                    </div>
                    <form class="auth-form__form">
                        <div class="auth-form__group">
                            <input type="text" class="auth-form__input" placeholder="Email của bạn" required />
                        </div>
                        <div class="auth-form__group">
                        ...
                        <div class="auth-form__controls">
                            <button type="button" class="auth-form__controls-back btn&#45;&#45;normal">TRỞ LẠI<a class="nav-link" href="index_noLogin.jsp"></a></button>
                            <button type="submit" class="btn&#45;&#45;primary">ĐĂNG KÝ<a class="nav-link" href="index.jsp"></a></button>
                        </div>
                    </form>
                    <div class="auth-form__socials">
                        <a href="#"
                            class="auth-form__socials&#45;&#45;facebook btn&#45;&#45;size-s btn&#45;&#45;with-icon">
                            <i class="auth-form__socials-icon fa-brands fa-square-facebook"></i>
                            <span class="auth-form__socials-title">Kết nối với Facebook</span>
                        </a>
                        <a href="#"
                            class="auth-form__socials&#45;&#45;google btn&#45;&#45;size-s btn&#45;&#45;with-icon">
