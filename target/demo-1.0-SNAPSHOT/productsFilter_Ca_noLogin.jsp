...
<nav class="category-nav">
    <ul>
        ...
        <li><a class="product-filter active" href="productsFilter_Ca_noLogin.html">Cá</a></li>
...
<h2 style="text-align:center; margin-top:20px;">Sản phẩm thuộc danh mục Cá</h2>

<div class="product-list">
    <div class="product-card">
        <img src="https://cdn.hstatic.net/products/1000030244/sdsw_ce304e86cb074834b6d4a644e604201f_grande.png" alt="Cá Hồi Phi Lê" />
        <h3>Cá Hồi Phi Lê</h3>
        <p class="price">215.000 VNĐ</p>
        <p class="weight">300g/gói</p>
        <p class="popularity">Đã bán: 1.364 lượt</p>
        <div class="rating">
    ...
    <div class="product-card">
        <img src="https://cdn.hstatic.net/products/1000030244/combo3vi_32901feee6fb4e908069567e0d1c8fc3_grande.png" alt="Cá Trích Tươi" />
        <h3>Cá Trích Tươi</h3>
    ...
    <div class="product-card">
        <img src="https://cdn.hstatic.net/products/1000030244/td2_338038335f9948a884e97151e17b7154_grande.png" alt="Cá Nục" />
        <h3>Cá Nục</h3>
        <p class="price">125.000 VNĐ</p>
        <p class="weight">500g/gói</p>
        <p class="popularity">Đã bán: 1.012 lượt</p>
        <div class="rating">
            <i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>
            <i class="fa-solid fa-star"></i><i class="fa-regular fa-star"></i>
            <i class="fa-regular fa-star"></i>
    ...
    <div class="product-card">
        <img src="https://cdn.hstatic.net/products/1000030244/td4_4205d643172443b99e3669153adea192_grande.png" alt="Cá Basa Phi Lê" />
        <h3>Cá Basa Phi Lê</h3>
        <p class="price">159.000 VNĐ</p>
        <p class="weight">400g/gói</p>
        <p class="popularity">Đã bán: 1.184 lượt</p>
        <div class="rating">
            <i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>
            <i class="fa-solid fa-star"></i><i class="fa-solid fa-star-half-stroke"></i>
            <i class="fa-regular fa-star"></i>
    ...
    <div class="product-card">
        <img src="https://product.hstatic.net/1000030244/product/thiet_ke_chua_co_ten_58ef2efc146744cfb193a65011955e7d_grande.png" alt="Cá Chỉ Vàng Một Nắng" />
    ...
    <div class="product-card">
        <img src="https://product.hstatic.net/1000182631/product/img_7190_e5244d1bb99f495bb3c7868f9a97ff71_medium.png" alt="Cá Cam" />
        <h3>Cá Cam</h3>
        <p class="price">139.000 VNĐ</p>
        <p class="weight">500g/gói</p>
        <p class="popularity">Đã bán: 978 lượt</p>
        <div class="rating">
            <i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>
            <i class="fa-solid fa-star"></i><i class="fa-regular fa-star"></i>
            <i class="fa-regular fa-star"></i>
    ...
    <div class="product-card">
        <img src="https://product.hstatic.net/1000030244/product/web_141f2f06e02b42ffaec7d475f763922f_grande.jpg" alt="Cá Chiêm" />
        <h3>Cá Chiêm</h3>
    ...
    <div class="product-card">
        <img src="https://product.hstatic.net/1000030244/product/02__3__dbfb52e579a04d02b68d896a89d62240_grande.jpg" alt="Cá Trích Muối" />
        <h3>Cá Trích Muối</h3>
        <p class="price">175.000 VNĐ</p>
        <p class="weight">400g/gói</p>
        <p class="popularity">Đã bán: 654 lượt</p>
        <div class="rating">
            <i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>
            <i class="fa-solid fa-star"></i><i class="fa-regular fa-star"></i>
            <i class="fa-regular fa-star"></i>
    ...
    <div class="product-card">
        <img src="https://cdn.hstatic.net/products/1000030244/avatacathu_a32a441956a44425a25c63c3a8912b39_grande.png" alt="Cá Linh" />
        <h3>Cá Linh</h3>
        <p class="price">199.000 VNĐ</p>
        <p class="weight">500g/gói</p>
        <p class="popularity">Đã bán: 721 lượt</p>
        <div class="rating">
            <i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>
            <i class="fa-solid fa-star"></i><i class="fa-solid fa-star-half-stroke"></i>
            <i class="fa-regular fa-star"></i>
    ...
    <div class="product-card">
        <img src="https://cdn.hstatic.net/products/1000030244/td5_14142793037149caa1cdcbdb2b26886f_grande.png" alt="Cá Rô Phi Lê" />
        <h3>Cá Rô Phi Lê</h3>
        <p class="price">149.000 VNĐ</p>
        <p class="weight">300g/gói</p>
        <p class="popularity">Đã bán: 584 lượt</p>
        <div class="rating">
            <i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>
            <i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>
            <i class="fa-regular fa-star"></i>
