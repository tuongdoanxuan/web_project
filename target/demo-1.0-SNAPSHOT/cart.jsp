                    ...
                    <div class="cart-dropdown">
                        ...
                        <div class="cart-summary">
                            ...
                            <div class="cart-buttons">
                                <a href="cart.html" class="view-cart">Xem giỏ hàng</a>
...
<main class="cart-wrapper">
    ...
    <div class="cart-row cart-head">
        ...
        <div class="col col-action">Thao tác</div>
    </div>
    ...
    <div class="cart-row">
        <div class="col col-product">
            ...
            <img src="https://product.hstatic.net/200000325181/product/1_fee63a7c3f4c4a49b6d22d3397a5eb45_master.jpg" alt="Tôm Sú" />
            <span>Tôm Sú Tươi 500g</span>
        </div>
        <div class="col col-price">145.000₫</div>
        <div class="col col-qty"><input type="number" value="1" min="1" /></div>
        <div class="col col-total">145.000₫</div>
        <div class="col col-action"><button class="btn-remove"><i class="fa-solid fa-trash"></i></button></div>
    </div>
    ...
    <div class="cart-row">
        <div class="col col-product">
            <input type="checkbox" class="item-check" />
            <img src="https://i.imgur.com/Bj4vYxB.jpg" alt="Cua Gạch" />
            <span>Cua Gạch Cà Mau</span>
        </div>
        <div class="col col-price">220.000₫</div>
        <div class="col col-qty"><input type="number" value="1" min="1" /></div>
        <div class="col col-total">220.000₫</div>
        <div class="col col-action"><button class="btn-remove"><i class="fa-solid fa-trash"></i></button></div>
    </div>

    <div class="cart-footer">
        <div class="cart-total-label">Tổng cộng:</div>
        <div class="cart-total-amount">365.000₫</div>
        <a href="checkout.jsp" class="btn-checkout"><i class="fa-solid fa-credit-card"></i> Đặt hàng</a>
    </div>
</main>
