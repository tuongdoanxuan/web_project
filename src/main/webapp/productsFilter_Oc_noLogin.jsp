...
<nav class="category-nav">
    <ul>
        ...
        <li><a class="product-filter active" href="productsFilter_Oc_noLogin.html">Ốc</a></li>
...
<h2 style="text-align:center; margin-top:20px;">Sản phẩm thuộc danh mục Ốc</h2>

<div class="product-list">
    <div class="product-card">
        <img src="https://product.hstatic.net/1000030244/product/oc_huong__1__987281ffbad34ff1b399250b021feefb_grande.png" alt="Ốc Hút Biển" />
        <h3>Ốc Hút Biển</h3>
        <p class="price">129.000 VNĐ</p>
        <p class="weight">500g/gói</p>
        <p class="popularity">Đã bán: 645 lượt</p>
        <div class="rating">
    ...
    <div class="product-card">
        <img src="https://product.hstatic.net/1000030244/product/so_lua_hinh_website_54b68e85d5b34a34acae1b24cd7ce3b2_grande.png" alt="Ốc Mực" />
        <h3>Ốc Mực</h3>
    ...
    <div class="product-card">
        <img src="https://product.hstatic.net/1000030244/product/oc_huong_2d835931b0364e6180042eb6b78fc640_grande.png" alt="Ốc Sen" />
        <h3>Ốc Sen</h3>
        <p class="price">139.000 VNĐ</p>
        <p class="weight">500g/gói</p>
        <p class="popularity">Đã bán: 478 lượt</p>
        <div class="rating">
            <i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>
            <i class="fa-solid fa-star"></i><i class="fa-regular fa-star"></i>
            <i class="fa-regular fa-star"></i>
    ...
    <div class="product-card">
        <img src="https://product.hstatic.net/1000030244/product/oc_huong_2d835931b0364e6180042eb6b78fc640_grande.png" alt="Ốc Len" />
        <h3>Ốc Len</h3>
        <p class="price">119.000 VNĐ</p>
        <p class="weight">500g/gói</p>
        <p class="popularity">Đã bán: 632 lượt</p>
        <div class="rating">
            <i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>
            <i class="fa-solid fa-star"></i><i class="fa-solid fa-star-half-stroke"></i>
            <i class="fa-regular fa-star"></i>
    ...
    <div class="product-card">
        <img src="https://cdn.hstatic.net/products/1000030244/ocbulotaw_08d83daef124463098b0c565d22969bc_grande.png" alt="Ốc Mút" />
        <h3>Ốc Mút</h3>
        <p class="price">129.000 VNĐ</p>
        <p class="weight">400g/gói</p>
        <p class="popularity">Đã bán: 558 lượt</p>
        <div class="rating">
            <i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>
            <i class="fa-solid fa-star"></i><i class="fa-regular fa-star"></i>
            <i class="fa-regular fa-star"></i>
    ...
    <div class="product-card">
        <img src="https://cdn.hstatic.net/products/1000030244/ocbulotsot_e25432107fa6403b99273e8c4e5bbe8e_grande.png" alt="Ốc Đảo" />
        <h3>Ốc Đảo</h3>
        <p class="price">149.000 VNĐ</p>
        <p class="weight">500g/gói</p>
        <p class="popularity">Đã bán: 491 lượt</p>
        <div class="rating">
            <i class="fa-solid fa-star"></i><i class="fa-solid fa-star"></i>
            <i class="fa-solid fa-star"></i><i class="fa-solid fa-star-half-stroke"></i>
            <i class="fa-regular fa-star"></i>
    ...
    <div class="product-card">
        <img src="https://cdn.hstatic.net/products/1000030244/_c-h__ng_7737c6c02b98413c81442ac88f7bd80e_grande.png" alt="Ốc Luộc" />
        <h3>Ốc Luộc</h3>
        <p class="price">159.000 VNĐ</p>
        <p class="weight">500g/gói</p>
