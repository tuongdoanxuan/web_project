    ...
    <div class="account-wrapper">
        ...
        <aside class="sidebar">
            ...
            <ul class="menu">
                ...
                <li><a href="myOrders.html"><i class="fa-solid fa-box"></i> Đơn hàng của tôi</a></li>
        ...
        <section class="account-content">
            ...
            <div class="orders-table">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>#DH001<a class="nav-link" href="myOrders_detail.jsp"></a></td>
                            <td>05/11/2025</td>
                            <td>
                                Tôm Sú Tươi 500g x1<br />
                                Cua Gạch Cà Mau x1
                                <a class="nav-link" href="myOrders_detail.jsp"></a>
                            </td>
                            <td>365.000₫</td>
                            <td><span class="status delivered">Đã giao</span></td>
                        </tr>
                        <tr>
                            <td>#DH002<a class="nav-link" href="myOrders_detail.jsp"></a></td>
                            <td>03/11/2025</td>
                            <td>
                                Mực Nang x2
                                <a class="nav-link" href="myOrders_detail.jsp"></a>
