...
<head>
    ...
    <link rel="stylesheet" href="css/account.css"> <!--Xài chung-->
...
<div class="account-wrapper">
    ...
    <aside class="sidebar">
        ...
        <ul class="menu">
            ...
            <li><a href="change-password.html"><i class="fa-solid fa-lock"></i> Đổi mật khẩu</a></li>
    ...
    <section class="account-content">
        ...
        <form class="account-form">
            ...
            <div class="form-group">
                <label for="firstname">Xác nhận mật khẩu mới:</label>
                <input type="password"/>
            </div>
