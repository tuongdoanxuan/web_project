            ...
            <div class="auth-form forgot-form">
                ...
                <form class="auth-form__form">
                    <div class="auth-form__group">
                        <input type="email" class="auth-form__input" placeholder="Nhập email để khôi phục" required />
                    </div>
                    <div class="auth-form__aside">
                        <p class="auth-form__policy-text">
                            Chúng tôi sẽ gửi liên kết khôi phục mật khẩu đến email của bạn.
                        </p>
                    </div>
                    <div class="auth-form__controls">
                        <button type="button" class="btn--normal">Trở lại<a class="nav-link" href="index_showLogin.jsp"></a></button>
                        <button type="submit" class="btn--primary">Gửi yêu cầu<a class="nav-link" href="index_showForgotPNext.jsp"></a></button>
                    </div>
                </form>
            </div>
        </div>
