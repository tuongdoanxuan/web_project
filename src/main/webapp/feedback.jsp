...
<header>
    ...
    <section class="feedback-section">
        <h2>Đánh Giá – Bình Luận – Góp Ý</h2>
        <form class="feedback-form">
            <label for="name">Họ và tên</label>
            <input type="text" id="name" name="name" placeholder="Nhập họ tên của bạn" required />

            <label for="email">Email</label>
            <input type="email" id="email" name="email" placeholder="Email liên hệ (không bắt buộc)" />

            <label for="type">Loại phản hồi</label>
            <select id="type" name="type">
                <option value="review">Đánh giá chất lượng</option>
                <option value="comment">Bình luận về dịch vụ</option>
            ...
            <textarea id="message" name="message" rows="6" placeholder="Viết nội dung bạn muốn chia sẻ..."
                required></textarea>
